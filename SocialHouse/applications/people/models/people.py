...
from applications.people.models.abstract import ExtendedPerson


# from applications.serviced_data.models import Privilege
...
class ServicedPerson(ExtendedPerson):
    ...
    privileges = models.ManyToManyField(to='serviced_data.Privilege', verbose_name='Льготные категории', blank=True)
